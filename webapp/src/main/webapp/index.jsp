...
<div class="intro">
    <h1 class="name">Nilesh Ganvir</h1>
    <h3 style="font-weight: 400;">Devops Engineer</h3>
    <br>

    <p>
        Hi, Welcome to my personal web page. Thank you for loading here. If you explore this website you will get to know about me,
        what i have done in the past, what i'm currently do and my future.
        If you are interested to know more about me go to the about me page.
